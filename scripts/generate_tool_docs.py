...
def generate_docs():
    ...
    output.append("\n")
    output.append("This document provides a comprehensive reference for all MCP tools exposed by Research OS.\n")
    output.append("\n")
    ...
    output.append("- **view.*** - View tools (workspace tree, data preview, figure display)\n")
    output.append("- **tool.*** - Research tools (data transform, statistical tests, figures)\n")
    output.append("\n")
    output.append("---\n")
    output.append("\n")
