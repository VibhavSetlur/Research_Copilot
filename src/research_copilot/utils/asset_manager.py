"""Access packaged Research Copilot assets with optional local overrides.

The installed package owns immutable prompts, skills, schemas, workflows, and
domain registries under ``research_copilot.assets``. A project may override a
...
ASSET_PACKAGE = "research_copilot.assets"
...
class AssetManager:
    ...
    def find_project_root(start: Optional[Path] = None) -> Path:
        """Find a Research Copilot workspace without requiring ``.research/``."""
