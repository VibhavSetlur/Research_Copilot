...
class InterpretativeCoupler:
    ...
    def _resolve_interpretation_path(self, figure_path: Path, branch_id: str) -> Path:
        ...
        # Places .interpret.md as a sibling to the figure
        stem = figure_path.stem
        return figure_path.parent / f"{stem}.interpret.md"
    ...
    def _build_interpretation(
        ...
        relative_path = (
            figure_path.relative_to(self.root)
        ...
        sections.extend(
            [
                ...
                "",
                "---",
                "*Auto-generated by Research OS Interpretative Coupling*",
            ]
        )
    ...
    def _generate_statistical_interpretation(self, results: Dict[str, Any]) -> str:
        ...
        if "effect_size" in results:
            ...
            lines.append(f"- **Effect size**: β = {es:.3f} [{ci[0]:.3f}, {ci[1]:.3f}]")
        ...
        if "test_statistic" in results:
            lines.append(
                f"- **Test statistic**: {results.get('test_name', 't')} = "
        ...
        if not lines:
            lines.append(
                "- Statistical results not available in metadata. "
    ...
    def _generate_key_takeaways(
        ...
        if results:
            ...
            if p < 0.05:
                ...
                if abs(es) > 0.5:
                    ...
                    takeaways.append(f"- The effect size (β = {es:.3f}) is moderate.")
                else:
                    takeaways.append(
        ...
        if not takeaways:
            ...
            takeaways.append("- Note any outliers, clusters, or unexpected patterns.")
