...
from research_os.schemas.state_schema import EpisodicMemory, SemanticMemory, MemoryState
...
class MemorySynthesizer:
    ...
    def __init__(self, ledger: ResearchLedger, call_llm_fn=None):
        ...
        if call_llm_fn:
            ...
            from research_os.chat import call_llm
    ...
    def synthesize_episode(self, trigger: str, recent_turns: List[Dict[str, str]], decisions: Optional[List[str]] = None, rejected: Optional[List[str]] = None) -> EpisodicMemory:
        ...
        prompt = (
            "You are the MemorySynthesizer for Research OS.\n"
