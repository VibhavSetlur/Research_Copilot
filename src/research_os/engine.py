"""ResearchEngine — unified headless execution engine for Research OS.
...
class ResearchEngine:
    """Unified headless execution engine for Research OS.
    ...
    Attributes:
        ...
        analyzer:          IntentAnalyzer for passive query analysis.
    ...
    def __init__(
        ...
        self.router = IntentAnalyzer(self.root)
    ...
    def _run_script(
        ...
        *,
        ...
        from research_os.utils.executor import ResearchExecutor
    ...
    def analyze_query(self, query: str, depth: str = "academic") -> Dict[str, Any]:
        ...
        This is a passive analysis — no routing, no DAG building, no execution.
        The IDE receives the intake schema and decides which tools to call next.
        """
