...
from research_os.utils.common import find_project_root, load_json, save_json

RUNTIME_PROFILES = {
    "local_fast": {"engine": "local", "timeout": 300, "parallel": True, "container": None},
    "docker_isolated": {"engine": "docker", "timeout": 3600, "parallel": False, "container": "research-os:latest"},
    "slurm_cluster": {"engine": "slurm", "timeout": 86400, "parallel": True, "container": "research-os:hpc"},
    "aws_batch": {"engine": "aws_batch", "timeout": 86400, "parallel": True, "container": "research-os:cloud"}
}
